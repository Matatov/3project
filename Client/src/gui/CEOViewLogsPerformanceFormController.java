...
public class CEOViewLogsPerformanceFormController implements Initializable {
	...
	@FXML
	private TableColumn<?, String> deliveryColumn;

	@FXML
	private TableColumn<?, String> addressColumn;

	@FXML
	private TableColumn<?, String> dateColumn;

	@FXML
	private TableColumn<?, String> delayColumn;

	@FXML
	private TextField txtTotalDelay;
